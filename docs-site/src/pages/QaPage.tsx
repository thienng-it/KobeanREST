    ...
    <article className="docs-page">
      <header className="docs-hero" style={{ textAlign: "center", marginBottom: "32px" }}>
        ...
        <p style={{ maxWidth: "720px", margin: "0 auto", color: "#94a3b8" }}>
          Real-time daily test execution analytics, historical trend tracking, flakiness governance, and multi-tier verification matrix covering 127 Node.js contract test rules and 5 CodeceptJS / Playwright E2E GUI scenarios.
        </p>
      </header>
